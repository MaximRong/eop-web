...
import com.ailk.alipay.utils.httpClient.HttpProtocolHandler;
import com.ailk.alipay.utils.httpClient.HttpRequest;
import com.ailk.alipay.utils.httpClient.HttpResponse;
import com.ailk.alipay.utils.httpClient.HttpResultType;
...
public class AlipaySubmit {
    ...
    public static String buildForm(Map<String, String> sParaTemp, String gateway, String strMethod,
        ...
        sbHtml.append("<form id=\"alipaysubmit\" name=\"alipaysubmit\" action=\"" + gateway
                      + "_input_charset=" + AlipayConst.CHAR_SET + "\" method=\"" + strMethod
                      + "\">");
    ...
    public static String sendPostInfo(Map<String, String> sParaTemp, String gateway)
        ...
        //设置编码集
        request.setCharset(AlipayConst.CHAR_SET);

        request.setParameters(generatNameValuePair(sPara));
        request.setUrl(gateway + "_input_charset=" + AlipayConst.CHAR_SET);
